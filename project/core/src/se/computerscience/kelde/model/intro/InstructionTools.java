...
public final class InstructionTools {
    ...
    public static IntroInstruction createSevenParamInstruct(double startTime,double  endTime,float  keyFrame,int heightChange,
                                                            int widthChange,int xChange,int yChange,String animationName){
        return new  IntroInstruction(startTime, endTime, keyFrame, heightChange, widthChange, xChange, yChange, animationName);
    }

    public static IntroInstruction createSixParamInstruct(double startTime,double endTime,int heightChange,
                                                          int widthChange,int xChange,int yChange,String animationName){
