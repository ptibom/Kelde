...
public class GuiOverlayView {
    ...
    static final private int BUTTON_INVENTORY_TRUE_Y = 370;

    private final GuiOverlay guiOverlayModel;
    private final Texture menuRectangle;
    private final GuiButton  exitButton;
    ...
    public GuiOverlayView(GuiOverlay gameGuiModel, Viewport viewport) {
        ...
        exitButton = new GuiButton("Exit", GuiButton.createSkin(gameGuiModel.getGuiButtonImagePath()),
                BUTTON_X, BUTTON_INVENTORY_TRUE_Y);

        GuiButton mainMenuButton = new GuiButton("Main Menu", GuiButton.createSkin(gameGuiModel.getGuiButtonImagePath()),
                BUTTON_X, BUTTON_INVENTORY_TRUE_Y);
