...
public class SecondIntroSlave {
    ...
    public void draw(SpriteBatch batch, AnimationLoader animationLoader){
        ...
        animationHandlerSpell.drawAnimation(batch,animationLoader,51.5+ SECOND_INTRO_DELAY, 52+ SECOND_INTRO_DELAY,52+ SECOND_INTRO_DELAY,"start");
        animationHandlerSpell.drawAnimation(batch,animationLoader,52+ SECOND_INTRO_DELAY, 54.5+ SECOND_INTRO_DELAY,54.5+ SECOND_INTRO_DELAY,"loop");
        ...
        animationHandlerSpell.drawAnimation(batch,animationLoader,96.5+ SECOND_INTRO_DELAY, 97+ SECOND_INTRO_DELAY,97+ SECOND_INTRO_DELAY,"start");
        animationHandlerSpell.drawAnimation(batch,animationLoader,97+ SECOND_INTRO_DELAY, 99.5+ SECOND_INTRO_DELAY,99.5+ SECOND_INTRO_DELAY,"loop");
